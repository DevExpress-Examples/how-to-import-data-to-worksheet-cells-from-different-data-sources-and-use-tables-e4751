...
Namespace WindowsFormsApplication1
	Partial Public Class Form1
		...
		Private Sub CreateTable(ByVal workbook As IWorkbook)
			...
			table.HeaderRowRange.Alignment.Horizontal = DevExpress.Spreadsheet.HorizontalAlignment.Center
			table.TotalRowRange.Alignment.Horizontal = DevExpress.Spreadsheet.HorizontalAlignment.Center
			...
			For i As Integer = 1 To table.Columns.Count - 1
				table.Columns(i).DataRange.Alignment.Horizontal = DevExpress.Spreadsheet.HorizontalAlignment.Center
			Next i
